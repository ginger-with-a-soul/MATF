...
struct Node
{
  // Konstruktor za cvor
  /********* C++ deo *********/
  // Konstruktor sluzi da mozemo da napravimo instancu sturkture, u C-u kada smo radili sa srtukturama isli smo Node node; strcpy(node.word, ""); U C++-u mozemo direktno prilikom
  // pravljenja cvora da stavimo promenljivu word na praznu rec, a zatim cemo kad dodjemo do lista da promenimo vrednost ove promenljive
  Node()
  {
    word = "";
    count = 0;
...
int main ()
{
  ...
  /********* C++ deo *********/
  // std::priority_queue sluzi za implementaciju heap-a. Kao prvi parametarski argument (argumenti izmedju <>) dobija tip podataka koje cuva, kao drugi kolekciju koja se nalazimo
  // "ispo haube", a kao treci argument dobija funktor, funkciju i slicno sto odgovara uredjenju elemenata, tj nesto sto poredi elemente tipa koji se smestaju u heap, Node * u nasem
