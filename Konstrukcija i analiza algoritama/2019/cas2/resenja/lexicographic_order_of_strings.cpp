...
struct Node
{
  ...
  /********* C++ deo *********/
  // Mapa je u C++ u implementirana kao balansirana binarna stabla (crveno-crna stabla), s toga je garantovano da svaka od operacija umetanja, brisanja i pretrage ima slozenost
